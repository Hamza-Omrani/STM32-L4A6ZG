...
int main(void)
{
  ...
  MX_NVIC_Init();
  /* USER CODE BEGIN 2 */
  HAL_UART_Receive_IT(&hlpuart1, &Rx_UART_Data.Value ,1);
  /* USER CODE END 2 */
...
{
  xQueueSendFromISR(xQueue, &Rx_UART_Data.Value, NULL);
  HAL_UART_Receive_IT(&hlpuart1, &Rx_UART_Data.Value, 1);
}
...
/* USER CODE BEGIN Header_Data_Processing */
/**
* @brief  Function implementing the defaultTask thread.
* @param  argument: Not used 
* @retval None
*/
/* USER CODE END Header_Data_Processing */
void Data_Processing(void const * argument)
{
  /* USER CODE BEGIN 5 */
  int j; 
