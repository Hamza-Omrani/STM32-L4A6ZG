...
{ uint8_t Value;} Data;
Data Rx_UART_Data; 
uint8_t Rx_Queue_Data, i=0, myRxData[32] , myQueueData[32] , Timer_Buffer[32] = " Time Elapsed [sec]      \n";
...
int main(void)
{
  ...
  MX_TIM3_Init();
  /* USER CODE BEGIN 2 */
  HAL_UART_Receive_DMA(&hlpuart1, myRxData , 20);
  /* USER CODE END 2 */
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  for(k=10; k<20; k++)
  {
    xQueueSendFromISR(xQueue, &myRxData[k] , NULL);
  }
  HAL_UART_Receive_DMA(&hlpuart1, myRxData,20);
}
