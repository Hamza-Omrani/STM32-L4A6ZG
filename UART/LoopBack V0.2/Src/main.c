/* This project is aimed to transfer data via uart ,
then lunch a timer when the lette is 'S' , 
then stop the same time if the letter is 's'.
!!!!! twon theads are created here. 
*/ 
